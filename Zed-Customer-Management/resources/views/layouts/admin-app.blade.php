...
<head>
    ...
    <meta property="og:title" content="ZED Customer" />
    <meta property="og:description" content="ZED Customer" />
    <meta property="og:image" content="ZED Customer" />
...
***********************************-->
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="" target="_blank">ZED</a> 2023</p>
        </div>
    </div>
    <!--**********************************
      Footer end
